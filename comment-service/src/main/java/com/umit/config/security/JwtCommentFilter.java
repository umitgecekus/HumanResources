...
@Slf4j
public class JwtCommentFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (Objects.nonNull(authHeader) && authHeader.startsWith("Bearer ")){
            ...
            Optional<Long> role=jwtTokenManager.getIdFromToken(token);
            if (role.isPresent()){
                UserDetails userDetails= userDetail.getCommentById(role.get());
