...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> adminServiceHandler(CompanyServiceException companyServiceException){
        return new ResponseEntity<>(createErrorMessage(companyServiceException,companyServiceException.getErrorType()),
                companyServiceException.getErrorType().getHttpStatus());
    }
