...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> adminServiceHandler(AdminServiceException adminServiceException){
        return new ResponseEntity<>(createErrorMessage(adminServiceException,adminServiceException.getErrorType()),
                adminServiceException.getErrorType().getHttpStatus());
    }
